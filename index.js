...
exports.define = exports.componentDidMount = exports.selector = exports.reducer = void 0;
...
var reducer = function reducer(fn) {
  return function (state, setState) {
    return function () {
      ...
      return setTimeout( /*#__PURE__*/_asyncToGenerator(function* () {
...
var componentDidMount = function componentDidMount(fn) {
  return function (state, setState) {
    var useEffect = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _react["default"].useEffect;
    return function () {
      ...
      useEffect(function () {
        reducer(fn)(state, setState).apply(void 0, args);
      }, []);
    };
  };
};
